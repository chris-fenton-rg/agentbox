...
- ⚙️ **`agentbox.yaml`** — autogenerated setup and serices
- 🐳 **Docker-in-Docker** — start containers inside your VM
- 🌐 **Dedicated browser** — each box get his own dedicated Chromium browser
- 🖥️ **Screen sharing** — web viewer for the screen and browser
