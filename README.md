...
Just run `agent-box claude` to automatically spin a new VM from the current folder.
...
- ✨ **Auto Setup** - Autogenerated setup and services in the `agentbox.yaml` 
- 💾 **Warm checkpoints** — Sub 1s startup of new boxes
- 🐳 **Docker-in-Docker** — Run any container, db or service in each box
- 🌐 **Dedicated browser** — Each box get his own dedicated Chromium browser, resume where the AI left
- 🖥️ **Screen sharing** — Complete computer use via web viewer
- 🧩 **VS Code / Cursor attach** — Open any box in your IDE with a single command
